<div id="app-sidepanel" class="app-sidepanel">
  ...
  <div class="sidepanel-inner d-flex flex-column">
    ...
    <div class="app-branding">
      <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="{{ asset('assets-admin/images/logo/logo.png') }}" alt="logo" /><span class="logo-text">Oksigen Coffee</span></a>
    </div>
    <!--//app-branding-->
